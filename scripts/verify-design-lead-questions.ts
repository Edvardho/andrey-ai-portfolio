...
async function main() {
  ...
  const scenarios: MatrixScenario[] = [
    ...
    {
      label: 'global hypothesis validation phrasing',
    ...
    {
      label: 'global result metrics phrasing',
    ...
    {
      label: 'alfa short problem phrasing',
    ...
    {
      label: 'siebel redesign outcome phrasing',
    ...
    {
      label: 'sharing named constraints must not route to alfa',
    ...
    {
      label: 'mobile cases overview phrasing',
      input: 'Что он делал в мобильных кейсах, если коротко?',
      session: baseSession,
