...
const INJECTION_PATTERNS = [
  ...
  /system prompt/i,
  /покажи.+промпт/i,
  /(?:дай|скинь|покажи).+(?:свой|системн(?:ый|ого)?).+пром(?:п)?т/i,
...
const PRIVATE_DATA_PATTERNS = [
  ...
  /(?:какой|номер|личный|мобильный).{0,24}телефон/i,
  /телефон.{0,24}(?:андрея|его)/i,
  /passport/i,
  /паспорт/i,
  /(?:домашний|личный).{0,24}адрес/i,
  /адрес.{0,24}(?:андрея|его)/i,
];
