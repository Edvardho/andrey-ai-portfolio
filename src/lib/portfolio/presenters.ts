...
export function buildUnsupportedEnvelope(session: AssistantSession): AssistantEnvelope {
  ...
  return createEnvelope({
    ...
    contentBlocks: [
      {
        type: 'lead',
        title: 'Не знаю: в портфолио нет такой информации',
        body: [
          'Я могу опираться только на зафиксированные факты и не буду выдавать прогноз или внешнее предположение за результат.',
